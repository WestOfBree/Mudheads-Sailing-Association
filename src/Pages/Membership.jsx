            ...
            <form className="membership__form">
              ...
              <label>
                ...
                <label>
                    ...
                    <br />
                    <input type="checkbox" name="volunteerOptions" value="raceCommittee" /> RC Boat Commissioning Crew (April/May)
                    <input type="checkbox" name="volunteerOptions" value="raceCommittee" /> Race Committee (Weds. Nights - May/September)
                    <input type="checkbox" name="volunteerOptions" value="raceCommittee" /> Mid-Season Party (July)
                    <input type="checkbox" name="volunteerOptions" value="raceCommittee" /> Mudhead Benefit Cup Regatta (July)
                    <input type="checkbox" name="volunteerOptions" value="raceCommittee" /> Awards Banquet (September)
                    <input type="checkbox" name="volunteerOptions" value="raceCommittee" /> Annual Meeting & Holiday Party (December)
                    <input type="checkbox" name="volunteerOptions" value="generalSupport" /> General Support (Year 'Round)
            </label>
              <label>
